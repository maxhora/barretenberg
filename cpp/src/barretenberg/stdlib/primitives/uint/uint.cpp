...
{
    if constexpr ((Composer::type == plonk::ComposerType::PLOOKUP) ||
                  (Composer::type == plonk::ComposerType::EXAMPLE_HONK)) {
        // TODO: manage higher bit ranges
        const auto sequence = plookup_<Composer>::get_lookup_accumulators(
